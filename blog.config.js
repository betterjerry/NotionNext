...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'jdnotion,博客,杰D杂文馆',杰D, // 网站关键词 英文逗号隔开
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'betterjerry/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
